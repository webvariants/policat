...
class EditPetitionCounterForm extends BasePetitionForm {
  ...
  public function configure() {
    ...
    if ($this->getObject()->getKind() == Petition::KIND_EMAIL_TO_LIST && $this->getObject()->getShowEmailCounter() == Petition::SHOW_EMAIL_COUNTER_YES) {
        $this->getWidgetSchema()->setLabel('addnum_email_counter', 'Email counter start');
        ...
        $this->getWidgetSchema()->setLabel('target_num_email_counter', 'Email counter target');
