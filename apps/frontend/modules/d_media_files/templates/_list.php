        ...
        <tbody>
            <?php foreach ($files as $file): ?>
              <tr>
                  ...
                  <td>
                      <a class="btn btn-secondary btn-sm ajax_link" href="<?php echo url_for('media_files_rename', array('id' => $file->getId())) ?>">Rename</a>
                      <a class="btn btn-secondary btn-sm ajax_link" href="<?php echo url_for('media_files_delete', array('id' => $file->getId())) ?>">Delete</a>
                  </td>
              </tr>
            <?php endforeach ?>
        </tbody>
