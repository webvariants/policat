...
<ul class="breadcrumb">
  ...
  <li>
    <?php if ($link_petition): ?><a href="<?php echo url_for('media_files_list', array('id' => $petition->getId())) ?>"><?php endif ?>
      Media Files
      <?php if ($link_petition): ?></a><?php endif ?>
  </li><span class="divider">/</span>
  <li class="active"><?php if ($form->getObject()->isNew()): ?>New<?php else: ?>Rename<?php endif ?></li>
</ul>
