...
<form id="form" class="ajax_form form-horizontal" action="<?php echo $action ?>" method="post">
  <div class="control-group">
    ...
    <div class="controls" >
      ...
      <a class="btn btn-primary btn-sm ajax_link post" data-submit='<?php echo json_encode(array('csrf_token' => $csrf_token, 'id' => $target_list->getId())) ?>' href="<?php echo url_for('target_deactivate') ?>">deactivate</a>
      <?php endif ?>
