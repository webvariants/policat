...
<div class="row">
  <div class="span8">
    <form class="ajax_form form-horizontal" action="<?php echo url_for('petition_new_') ?>" method="post">
      ...
      <?php echo $form->renderRows('name', 'campaign_id', 'kind') ?>
      <fieldset>
        <legend>Customise sign-up form</legend>
        <div class="global_error">
          <span id="new_petition_customise"></span>
        </div>
        <?php echo $form->renderRows('nametype', 'with_address', 'with_country', 'default_country', 'country_collection_id', 'with_comments') ?>
      </fieldset>
