            ...
            <div class="tab-content">
                ...
                <?php if ($petition->getKind() == Petition::KIND_PLEDGE): ?>
                  <fieldset  class="tab-pane show-before-chosen-init" id="sec7">
                      ...
                      <?php echo $form->renderRows('pledge_with_comments', 'pledge_header_visual', 'pledge_key_visual', 'pledge_background_color', 'pledge_color', 'pledge_head_color', 'pledge_font', 'pledge_info_columns_comma', 'digest_enabled') ?>
                  </fieldset>
                <?php endif ?>
            </div>
        </div>
