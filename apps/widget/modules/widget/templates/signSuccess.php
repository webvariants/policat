...
<?php endif ?>
        ...
        <style type="text/css">
            ...
            h2.form_title, div.error p { color: <?php echo $form_title_color ?>; }
            <?php endif ?>
        </style>
    </head>
            ...
            <div id="policat_widget_left">
                <div id="content_left">
                    <div id="petition">
                        ...
                        <div id="left_tab" class="left_tab">
                        ...
                        <div id="right_tab" class="right_tab scroll">
                        ...
                        <div id="petition_tabs" class="left">
                            ...
                            <div class="right tab"><span class="button_color button_btn"><?php echo __('Background') ?></span></div>
                        </div>
                    </div>
                    ...
                    <div class="stage_right">
                        ...
                        <div class="embed_this">
                            ...
                            <form id="embed" action="" method="post">
                                ...
                                <?php
                                foreach (array('styling_type', 'styling_width', 'styling_title_color', 'styling_body_color', 'styling_bg_left_color', 'styling_bg_right_color', 'styling_form_title_color', 'styling_button_color') as $fieldname):
