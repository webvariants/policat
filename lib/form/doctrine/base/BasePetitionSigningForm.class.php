...
abstract class BasePetitionSigningForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ref_shown'              => new sfWidgetFormInputText(),
      'ref_hash'               => new sfWidgetFormInputText(),
      ...
      'mailexport_pending'     => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'mailexport_pending'     => new sfValidatorInteger(array('required' => false)),
