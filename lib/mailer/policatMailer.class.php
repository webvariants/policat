...
class policatMailer extends Swift_Mailer
{
  const
    REALTIME       = 'realtime',
    SPOOL          = 'spool',
  ...
  public function __construct(sfEventDispatcher $dispatcher, $options)
  {
    ...
    $constantName = 'policatMailer::'.strtoupper($options['delivery_strategy']);
    ...
    if (policatMailer::NONE == $this->strategy)
    {
    ...
    if (policatMailer::SPOOL == $this->strategy)
    {
    ...
    elseif (policatMailer::SINGLE_ADDRESS == $this->strategy)
    {
  ...
  public function setDeliveryAddress($address)
  {
    ...
    if (policatMailer::SINGLE_ADDRESS == $this->strategy)
    {
   ...
   *
   * @return policatMailer The current policatMailer instance
   */
