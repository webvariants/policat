...
abstract class BasePetitionSigningFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mailexport_pending'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'mailexport_pending'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
