 ...
 * @property string                                        $ref_hash                                           Type: string(160)
 ...
 * @property int                                           $mailexport_pending                                 Type: integer(1)
 ...
 * @method string                                          getRefHash()                                        Type: string(160)
 ...
 * @method PetitionSigning                                 setRefHash(string $val)                             Type: string(160)
...
abstract class BasePetitionSigning extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('ref_hash', 'string', 160, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 160,
             ));
        ...
        $this->hasColumn('mailexport_pending', 'integer', 1, array(
             'type' => 'integer',
             'notnull' => true,
             'default' => 0,
             'length' => 1,
