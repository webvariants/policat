 ...
 *  
 * @method Store       setKey(string $val)        Type: string(80)
 * @method Store       setValue(string $val)      Type: clob
 * @method Store       setLanguageId(string $val) Type: string(5)
 * @method Store       setLanguage(Language $val) 
 *  
 * @package    policat
 * @subpackage model
 * @author     Martin
