...
class StoreTable extends Doctrine_Table {
  ...
  const PRIVACY_TITLE = 'privacy_title';
  const PRIVACY_CONTENT = 'privacy_content';
  const PRIVACY_MENU = 'privacy_menu';
  const PRIVACY_FOOTER = 'privacy_footer';
  ...
  static $meta = array(
      ...
      'instant_chat' => array(
          ...
          'fields' => array(
              ...
              self::INSTANT_CHAT_SITE_ID => array(
                  'widget' => array('sfWidgetFormInputText', array('label' => 'Tawk.to Site ID'), array('class' => 'span7 elastic highlight')),
                  'validator' => array('sfValidatorString', array('required' => false)),
              ),
              self::INSTANT_CHAT_API_KEY => array(
                  'widget' => array('sfWidgetFormInputText', array('label' => 'Tawk.to API KEY'), array('class' => 'span7 elastic highlight')),
                  'validator' => array('sfValidatorString', array('required' => false)),
              ),
          )
      ),
...
//                  'help' => ''
      ...
      'privacy' => array(
          ...
          'fields' => array(
              ...
              self::PRIVACY_MENU => array(
                  'widget' => array('WidgetBoolean', array('label' => 'Link in menu')),
                  'validator' => array('sfValidatorBoolean')
              ),
              self::PRIVACY_FOOTER => array(
                  'widget' => array('WidgetBoolean', array('label' => 'Link in footer')),
                  'validator' => array('sfValidatorBoolean')
              )
          )
